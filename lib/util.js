...
(function() {
  var Dupe, Pair, addDupe, decycle, decycleArray, decycleObject, flatten, isAsync, isFunction, isSync, nest, pretty, prettyArray, prettyKeyVal, prettyObject, stringify;
  ...
  stringify = function(obj) {
    return flatten(pretty(obj)).join('');
  };
