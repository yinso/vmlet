...
(function() {
  var AST, CPS, Promise, RESOLVER, Runtime, Session, SymbolTable, TR, Unit, errorlet, escodegen, esnode, fs, loglet, parser, util, vm,
    __slice = [].slice;
  ...
  Runtime = (function() {
    ...
    Runtime.prototype["eval"] = function(stmt, cb) {
      ...
      try {
        ...
        ast = RESOLVER.transform(ast, new SymbolTable(this.baseEnv));
