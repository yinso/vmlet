...
(function() {
  var AST, CPS, Module, RESOLVER, Runtime, Session, SymbolTable, TR, Toplevel, UNIQ, Unit, async, errorlet, escodegen, esnode, fs, loglet, parser, util, vm,
    __slice = [].slice;
  ...
  Module = (function() {
    ...
    Module.prototype["export"] = function(key, as) {
      ...
      return this.exports[as] = this.get(key);
    };
  ...
  Toplevel = (function() {
    ...
    function Toplevel(depends, proc, module) {
      ...
      this.proc = proc;
      this.module = module;
      console.log('Toplevel.ctor', this.module.name);
    }
  ...
  Runtime = (function() {
    ...
    Runtime.prototype["eval"] = function(stmt, cb) {
      ...
      if (stmt.indexOf(':modules') === 0) {
        return cb(null, util.stringify(this.modules));
      } else if (stmt.indexOf(':env') === 0) {
        return cb(null, util.stringify(this.main));
      }
      try {
