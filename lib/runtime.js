...
(function() {
  var ANF, AST, CPS, Environment, Module, PROC, RESOLVER, Runtime, Session, TR, Toplevel, Unit, async, compiler, errorlet, fs, loglet, parser, util, vm,
    __slice = [].slice;
  ...
  Module = (function() {
    ...
    Module.fromPrev = function(name, prevEnv) {
      return new this(name, prevEnv.pushEnv());
    };

    function Module(name, env) {
      this.name = name;
      this.env = env != null ? env : Environment.make();
      this.inner = {};
      this.imports = {};
      this.exports = {};
      this.depends = [];
  ...
  Runtime = (function() {
    ...
    function Runtime(baseEnv, main) {
      this.baseEnv = baseEnv != null ? baseEnv : Environment.make();
    ...
    Runtime.prototype.setToggle = function(key) {
      if (this.settings[key]) {
        this.settings[key] = false;
      } else {
        this.settings[key] = true;
      }
      return console.log('-- Runtime.setToggle', key, this.settings[key]);
    };
        ...
        return fs.readFile(spec, 'utf8', function(err, data) {
          ...
          if (err) {
            ...
            try {
              ...
              _this.envs[spec] = _this.baseEnv.pushEnv();
