...
(function() {
  var AST, CPS, LexicalEnvironment, Promise, RESOLVER, Runtime, Session, TR, Unit, baseEnv, errorlet, escodegen, esnode, fs, loglet, parser, util, vm,
    __slice = [].slice;
  ...
  Runtime = (function() {
    ...
    Runtime.prototype.makeProc = function(func, def) {
    ...
    Runtime.prototype["eval"] = function(stmt, cb) {
      ...
      try {
        ...
        ast = RESOLVER.transform(ast, new LexicalEnvironment(this.baseEnv));
