...
(function() {
  var ANF, AST, CPS, DEFINE, Environment, Module, RESOLVER, Runtime, Session, TR, Toplevel, Unit, async, compiler, errorlet, fs, loglet, parser, util, vm,
    __slice = [].slice;
  ...
  Module = (function() {
    ...
    Module.fromPrev = function(name, prevEnv) {
      return new this(name, new Environment(prevEnv));
    };
  ...
  Runtime = (function() {
    ...
    function Runtime(baseEnv, main) {
      this.baseEnv = baseEnv != null ? baseEnv : new Environment();
        ...
        return fs.readFile(spec, 'utf8', function(err, data) {
          ...
          if (err) {
            ...
            try {
              ...
              _this.envs[spec] = new Environment(_this.baseEnv);
