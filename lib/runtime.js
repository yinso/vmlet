...
(function() {
  ...
  CompileTimeEnvironment = (function(_super) {
    ...
    CompileTimeEnvironment.prototype.get = function(key) {
      return AST.make('funcall', AST.make('member', AST.make('symbol', '_rt'), AST.make('symbol', 'get')), [AST.make('string', key)]);
    };
  ...
  Runtime = (function() {
    ...
    function Runtime(baseEnv) {
      ...
      this.baseEnv.define('runtime', this);
      this.baseEnv.define('__done', function(err, res) {
