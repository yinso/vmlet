module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c55 = function(exp) { return exp; },
        peg$c56 = function(op) { return op; },
        peg$c57 = function(exp) { return exp ; },
        peg$c58 = function(n) { return n; },
        peg$c59 = function(str) { return str; },
        peg$c60 = function(bool) { return bool; },
        peg$c61 = function(sym) { return sym; },
        peg$c62 = function(obj) { return obj; },
        peg$c63 = function(ary) { return ary; },
        peg$c64 = function(block) { return block; },
        peg$c65 = function(t) { return t; },
        peg$c66 = function(define) { return define; },
        peg$c67 = function(func) { return func; },
        peg$c68 = function(task) { return task; },
        peg$c69 = "=",
        peg$c70 = { type: "literal", value: "=", description: "\"=\"" },
        peg$c71 = function(id, exp) { return helper.define(id, exp); },
        peg$c72 = function(id, params, exp) {
          return helper.define(id, helper.function(id, params, exp));
        },
        peg$c73 = function(id, params, exp) { 
          return helper.define(id, helper.task(id, params,exp)); 
        },
        peg$c74 = null,
        peg$c75 = function(id, params, exp) { return helper.function(id, params,exp); },
        peg$c76 = "(",
        peg$c77 = { type: "literal", value: "(", description: "\"(\"" },
        peg$c78 = ")",
        peg$c79 = { type: "literal", value: ")", description: "\")\"" },
        peg$c80 = function(params) { return params; },
        peg$c81 = ",",
        peg$c82 = { type: "literal", value: ",", description: "\",\"" },
        peg$c83 = function(param) { return helper.param(param); },
        peg$c84 = function(id, params, exp) { return helper.task(id, params,exp); },
        peg$c85 = function(cond, thenExp, elseExp) {
          return helper.if(cond, thenExp, elseExp);
        },
        peg$c86 = function(lhs, rest) { return helper.operator(lhs, rest); },
        peg$c87 = "||",
        peg$c88 = { type: "literal", value: "||", description: "\"||\"" },
        peg$c89 = function(op, rhs) { return {op: 'or', rhs: rhs}; },
        peg$c90 = "&&",
        peg$c91 = { type: "literal", value: "&&", description: "\"&&\"" },
        peg$c92 = function(op, rhs) { return {op: 'and', rhs: rhs}; },
        peg$c93 = "==",
        ...
        peg$c105 = function(op, rhs) { return {op: op, rhs: rhs}; },
        peg$c106 = "-",
        ...
        peg$c118 = function(exps) { return helper.block(exps); },
        peg$c119 = "[",
        peg$c120 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c121 = "]",
        peg$c122 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c123 = function(items) { return helper.array(items); },
        peg$c124 = function(item) { return item; },
        peg$c125 = function(keyVals) { return helper.object(keyVals); },
        peg$c126 = ":",
        peg$c127 = { type: "literal", value: ":", description: "\":\"" },
        peg$c128 = function(key, val) { return [ key, val ]; },
        peg$c129 = function(e) { return helper.throw(e); },
        peg$c130 = function(body, catches, fin) { return helper.try(body, catches, fin); },
        peg$c131 = function(param, body) { return helper.catch(param, body); },
        peg$c132 = function(param) { return param; },
        peg$c133 = function(body) { return helper.finally(body); },
        peg$c134 = function(condExp, thenExp, elseExp) { 
          return helper.if(condExp, thenExp, elseExp); 
        },
        peg$c135 = function(parened) { return parened; },
        peg$c136 = function() { return helper.bool(true); },
        peg$c137 = function() { return helper.bool(false); },
        peg$c138 = function() { return helper.null(); },
        peg$c139 = void 0,
        peg$c140 = function(c1, rest) { return helper.symbol(c1, rest); },
        peg$c141 = /^[^ \t\n\r\-0-9(); "',`{}.,:[\]]/,
        peg$c142 = { type: "class", value: "[^ \\t\\n\\r\\-0-9(); \"',`{}.,:[\\]]", description: "[^ \\t\\n\\r\\-0-9(); \"',`{}.,:[\\]]" },
        peg$c143 = /^[^ \t\n\r(); "',`{}.,:[\]]/,
        peg$c144 = { type: "class", value: "[^ \\t\\n\\r(); \"',`{}.,:[\\]]", description: "[^ \\t\\n\\r(); \"',`{}.,:[\\]]" },
        peg$c145 = function(inner) { return helper.taskcall(inner); },
        peg$c146 = function(bindings, spec) { return helper.import(spec, bindings); },
        peg$c147 = function(spec) { return helper.import(spec); },
        peg$c148 = function(bindings) { return bindings; },
        peg$c149 = "as",
        peg$c150 = { type: "literal", value: "as", description: "\"as\"" },
        peg$c151 = function(sym, as) { return helper.binding(sym, as); },
        peg$c152 = function(sym) { return helper.binding(sym); },
        peg$c153 = function(bindings) { return helper.export(bindings); },
        peg$c154 = function(head, keys) { return helper.member(head, keys); },
        peg$c155 = function(num) { return num; },
        peg$c156 = function(p) { return p; },
        peg$c157 = ".",
        peg$c158 = { type: "literal", value: ".", description: "\".\"" },
        peg$c159 = function(args) { return helper.arguments(args); },
        peg$c160 = function(arg) { return arg; },
        peg$c161 = function() { return ',' },
        peg$c162 = function(s) { return s.value; },
        peg$c163 = function(s) { return s; },
        peg$c164 = "\"",
        peg$c165 = { type: "literal", value: "\"", description: "\"\\\"\"" },
        peg$c166 = function(chars) { return helper.string(chars); },
        peg$c167 = "'",
        peg$c168 = { type: "literal", value: "'", description: "\"'\"" },
        peg$c169 = /^[^"'\\\0-\x1F]/,
        peg$c170 = { type: "class", value: "[^\"'\\\\\\0-\\x1F]", description: "[^\"'\\\\\\0-\\x1F]" },
        peg$c171 = "\\\"",
        ...
        peg$c183 = "\\b",
        peg$c184 = { type: "literal", value: "\\b", description: "\"\\\\b\"" },
        ...
        peg$c200 = function(digits) {
          return String.fromCharCode(parseInt("0x" + digits));
        },
        peg$c201 = function(h1, h2, h3, h4) { return h1+h2+h3+h4; },
        peg$c202 = function(int, frac, exp) { 
          return helper.number(int, frac, exp);
        },
        peg$c203 = function(int, frac) { 
          return helper.number(int, frac, '');
        },
        peg$c204 = function(frac) { 
          return helper.number('-', frac, '');
        },
        peg$c205 = function(frac) { 
          return helper.number('', frac, '');
        },
        peg$c206 = function(int, exp) { 
          return helper.number(int, '', exp);
        },
        peg$c207 = function(int) { 
          return helper.number(int, '', '');
        },
        peg$c208 = function(digits) { return digits.join(''); },
        peg$c209 = function(digits) { return ['-'].concat(digits).join(''); },
        peg$c210 = function(digits) { return ['.'].concat(digits).join(''); },
        peg$c211 = function(digits) { return ['e'].concat(digits).join(''); },
        peg$c212 = /^[eE]/,
        ...
        peg$c218 = /^[1-9]/,
        peg$c219 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c220 = /^[0-9a-fA-F]/,
        peg$c221 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c222 = { type: "other", description: "whitespace" },
        peg$c223 = /^[ \t\n\r]/,
        peg$c224 = { type: "class", value: "[ \\t\\n\\r]", description: "[ \\t\\n\\r]" },
        peg$c225 = /^[\n\r\u2028\u2029]/,
        peg$c226 = { type: "class", value: "[\\n\\r\\u2028\\u2029]", description: "[\\n\\r\\u2028\\u2029]" },
        peg$c227 = { type: "other", description: "end of line" },
        peg$c228 = "\r\n",
        peg$c229 = { type: "literal", value: "\r\n", description: "\"\\r\\n\"" },
        peg$c230 = "\n",
        peg$c231 = { type: "literal", value: "\n", description: "\"\\n\"" },
        peg$c232 = "\r",
        peg$c233 = { type: "literal", value: "\r", description: "\"\\r\"" },
        peg$c234 = "\u2028",
        ...
        peg$c246 = function(chars) { return {comment: chars.join('')}; },
