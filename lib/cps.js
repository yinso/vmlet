...
(function() {
  var AST, TR, combine, concat, cps, cpsAssign, cpsBlock, cpsCatch, cpsDefine, cpsIf, cpsLocal, cpsReturn, cpsScalar, cpsTask, cpsTaskcall, cpsThrow, cpsTry, errorlet, get, loglet, makeCallback, makeCpsDef, makeErrorHandler, normalize, override, register, types, util, _cpsOne;
  ...
  */
  ...
  makeErrorHandler = function(catchExp, finallyExp, cbAST, name) {
    ...
    return AST.local(name, AST.procedure(void 0, [catchExp.param], body));
  };
