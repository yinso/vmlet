  ...
  */
  ...
  makeCallback = function(contAST, cbAST, resParam) {
    ...
    if (contAST === cbAST) {
      ...
      return AST.procedure(void 0, [AST.param('err'), resParam], AST["if"](AST.symbol('err'), AST["return"](AST.funcall(cbAST, [AST.symbol('err')])), contAST));
    }
  };
