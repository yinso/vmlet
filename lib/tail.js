...
(function() {
  var AST, CLONE, Environment, REF, TR, determineRefLocation, isTailCall, isTailRecursive, normalize, normalizeRefs, tailRecursive, transform, _goto;
  ...
  _goto = function(ast, proc, labelVar) {
    ...
    tempVars = (function() {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        param = _ref[i];
        _results.push(CLONE.transform(param.name));
      }
      return _results;
    })();
    _ref = ast.args;
