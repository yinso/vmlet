...
(function() {
  ...
  Environment = (function() {
    ...
    Environment.prototype.newKey = function(key) {
      var name;
      name = key.value;
  ...
  _define = function(ast, env) {
    ...
    value = esnode.funcall(esnode.member(_compile(AST.moduleID, env), esnode.identifier('define')), [name, _compile(ast.value, env)]);
    id = (function() {
      switch (ast.name.type()) {
        case 'ref':
  ...
  _module = function(ast, env) {
    ...
    proc = esnode["function"](null, params, _compile(ast.body, env));
    return esnode.funcall(esnode.member(_compile(AST.runtimeID, env), esnode.identifier('module')), [_compile(ast.spec, env), imports, proc]);
  };
