...
(function() {
  var array, assign, binary, block, break_, case_, catch_, continue_, declare, defaultCase, expression, funcall, function_, identifier, if_, label_, literal, member, null_, object, program, return_, switch_, throw_, try_, undefined_, while_,
    __slice = [].slice;
