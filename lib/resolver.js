...
(function() {
  var ANF, AST, SymbolTable, T, errorlet, get, loglet, makeProc, register, tr, transform, transformArray, transformBinary, transformBlock, transformCatch, transformDefine, transformFinally, transformFuncall, transformIdentifier, transformIf, transformImport, transformMember, transformObject, transformParam, transformScalar, transformTaskcall, transformThrow, transformTopLevel, transformTry, _transTypes, _transform;
