...
(function() {
  var ANF, AST, SymbolTable, T, errorlet, get, loglet, makeProc, register, tr, transform, util, _array, _binary, _block, _catch, _define, _defineName, _defineVal, _export, _finally, _funcall, _identifier, _if, _import, _let, _member, _object, _param, _scalar, _taskcall, _throw, _toplevel, _transTypes, _transform, _try;
