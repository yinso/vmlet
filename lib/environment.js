...
(function() {
  ...
  SymbolTable = (function() {
    ...
    SymbolTable.prototype.hasName = function(sym) {
      return this.has(sym);
    };
    ...
    SymbolTable.prototype.isFreeVariable = function(sym) {
      return this._isFree(sym, this.level(), this.level());
    };

    SymbolTable.prototype._isFree = function(sym, level, topLevel) {
      if (this._has(sym)) {
        if (level === topLevel) {
          return false;
        } else if (level === 1) {
        ...
        return this.prev._isFree(sym, level - 1, topLevel);
      } else {
