...
(function() {
  ...
  GensymTable = (function() {
    ...
    GensymTable.prototype.gensym = function(prefix) {
      ...
      return AST.symbol(prefix + "$" + this.symid(prefix));
    };
    ...
    GensymTable.prototype.temp = function() {
      var name;
  ...
  LexicalEnvironment = (function(_super) {
    ...
    LexicalEnvironment.prototype.defineLocal = function(sym, val) {
      var newSym;
      if (this.has(sym)) {
        newSym = this.symMap.gensym(sym.value);
        this.define(sym, newSym);
        return newSym;
      } else {
        this.define(sym, val);
        return sym;
