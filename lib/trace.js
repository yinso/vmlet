...
(function() {
  var indent, isTracedHead, isTracedTail, log, objToStr, printObj, stringify, tab, tempName, trace, untab, untrace, _level, _temp, _trace, _traced, _untrace,
    __slice = [].slice;
