...
(function() {
  ...
  ANF = (function(_super) {
    ...
    ANF.prototype.propagateReturn = function() {
      ...
      this.items.push(ast);
      if (ast.type() === 'define') {
        return this.items.push(AST.make('return', AST.make('proxyval', '_rt.unit')));
      }
    };
    ...
    ANF.prototype._propagateReturn = function(ast) {
      ...
      switch (ast.type()) {
        ...
        case 'throw':
          return ast;
        case 'try':
          return this._propagateReturnTry(ast);
        case 'catch':
          return this._propagateReturnCatch(ast);
        case 'define':
          return ast;
        default:
          throw errorlet.create({
    ...
    ANF.prototype._propagateReturnCatch = function(ast) {
      var body;
      loglet.log('ANF._propagateReturnCatch', ast);
      body = this._propagateReturn(ast.body);
      return AST.make('catch', ast.param, body);
    };

    ANF.prototype._propagateReturnTry = function(ast) {
      var body, c, catches;
      ...
      catches = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          c = _ref[_i];
          _results.push(this._propagateReturn(c));
        }
        return _results;
      }).call(this);
