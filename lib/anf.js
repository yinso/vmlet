...
(function() {
  var AST, Environment, assign, errorlet, get, makeProc, normalize, normalizeBlock, override, register, tr, transform, _array, _binary, _block, _catch, _define, _export, _finally, _funcall, _identifier, _if, _import, _let, _local, _member, _object, _param, _proc, _scalar, _taskcall, _throw, _transTypes, _transform, _transformInner, _try;
  ...
  _identifier = function(ast, env, block) {
    return ast;
  };
  ...
  _try = function(ast, env, block) {
    ...
    fin = ast["finally"] instanceof AST ? _finally(ast["finally"], env, block) : null;
