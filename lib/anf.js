...
(function() {
  var AST, AnfTransformer, Environment, Hashmap, T, TR, util;
  ...
  AnfTransformer = (function() {

    function AnfTransformer() {}

    AnfTransformer.transform = function(ast) {
      if (!this.reg) {
        this.reg = new this();
      }
    ...
    AnfTransformer.prototype.transform = function(ast, env, block) {
      var res;
      if (env == null) {
    ...
    AnfTransformer.prototype.runInner = function(ast, env, block) {
      var res;
      if (block == null) {
        block = AST.block();
      }
    ...
    AnfTransformer.prototype._normalize = function(ast, block) {
      switch (ast.type()) {
        case 'toplevel':
        case 'module':
          return ast;
    ...
    AnfTransformer.prototype._normalizeBlock = function(ast) {
    ...
    AnfTransformer.prototype.run = function(ast, env, block) {
      var type;
      if (block == null) {
        block = AST.block();
      }
    ...
    AnfTransformer.prototype.assign = function(ast, env, block) {
      var sym;
    ...
    AnfTransformer.prototype._number = function(ast, env, block) {
      return block.push(ast);
    };

    AnfTransformer.prototype._string = function(ast, env, block) {
      return block.push(ast);
    };

    AnfTransformer.prototype._bool = function(ast, env, block) {
      return block.push(ast);
    };

    AnfTransformer.prototype._null = function(ast, env, block) {
      return block.push(ast);
    };

    AnfTransformer.prototype._unit = function(ast, env, block) {
      return block.push(ast);
    };

    AnfTransformer.prototype._symbol = function(ast, env, block) {
      var ref;
      ref = env.alias(ast);
      return ref.name;
    };

    AnfTransformer.prototype._ref = function(ast, env, block) {
      var ref;
    ...
    AnfTransformer.prototype._binary = function(ast, env, block) {
      var lhs, rhs;
    ...
    AnfTransformer.prototype._if = function(ast, env, block) {
    ...
    AnfTransformer.prototype._block = function(ast, env, block) {
      var i, res, _i, _ref;
    ...
    AnfTransformer.prototype._define = function(ast, env, block) {
    ...
    AnfTransformer.prototype._local = function(ast, env, block) {
      var cloned, exp, i, ref, res, result, _i, _len, _ref;
      ref = this.run(ast.name, env, block);
      if (ref.type() === 'symbol') {
        ref = env.get(ref);
      }
    ...
    AnfTransformer.prototype._object = function(ast, env, block) {
    ...
    AnfTransformer.prototype._array = function(ast, env, block) {
      var items, v;
      items = (function() {
    ...
    AnfTransformer.prototype._member = function(ast, env, block) {
      var head;
      head = this.run(ast.head, env, block);
      return this.assign(AST.member(head, ast.key), env, block);
    };

    AnfTransformer.prototype._funcall = function(ast, env, block) {
    ...
    AnfTransformer.prototype._taskcall = function(ast, env, block) {
      var arg, args, funcall;
      funcall = this.run(ast.funcall, env, block);
      args = (function() {
        var _i, _len, _ref, _results;
    ...
    AnfTransformer._proc = function(type) {
    ...
    AnfTransformer.prototype._procedure = AnfTransformer._proc('procedure');

    AnfTransformer.prototype._task = AnfTransformer._proc('task');

    AnfTransformer.prototype._param = function(ast, env, block) {
      var param, ref;
      ref = this.run(ast.name, env, block);
    ...
    AnfTransformer.prototype._throw = function(ast, env, block) {
      var exp;
      exp = this.run(ast.value, env, block);
      return block.push(AST["throw"](exp));
    };

    AnfTransformer.prototype._catch = function(ast, env, block) {
    ...
    AnfTransformer.prototype._finally = function(ast, env, block) {
      var body, newEnv;
      newEnv = env;
    ...
    AnfTransformer.prototype._try = function(ast, env, block) {
    ...
    AnfTransformer.prototype._import = function(ast, env, block) {
      var binding, defines;
      defines = (function() {
        var _i, _len, _ref, _results;
        _ref = ast.bindings;
    ...
    AnfTransformer.prototype._export = function(ast, env, block) {
    ...
    AnfTransformer.prototype._let = function(ast, env, block) {
      var body, define, defines, exp, newEnv, _i, _j, _len, _len1, _ref, _ref1, _results;
      newEnv = env;
      defines = [];
      _ref = ast.defines;
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        define = _ref[_i];
        this.run(define, newEnv, block);
      }
      body = this.run(ast.body, newEnv);
      if (body.type() === 'block') {
        _ref1 = body.items;
    ...
    AnfTransformer.prototype._toplevel = function(ast, env, block) {
      var body;
      body = this.runInner(ast.body, env, block);
      return ast.clone(AST["return"](body));
    };

    AnfTransformer.prototype._module = function(ast, env, block) {
      var body;
      body = this.runInner(ast.body, env, block);
      return ast.clone(AST["return"](body));
    };

    return AnfTransformer;
