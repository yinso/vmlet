...
(function() {
  var ARRAY, AST, BINARY, BLOCK, BOOL, CATCH, DEFINE, FINALLY, FUNCALL, IF, LIST, MEMBER, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, QUASI, QUOTED, REF, RETURN, STRING, SYMBOL, TEMPVAR, THROW, TRY, UNQUOTE, UNQUOTESPLICING, errorlet, loglet,
    __slice = [].slice,
