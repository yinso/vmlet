...
(function() {
  var ARRAY, ASSIGN, AST, BINARY, BLOCK, BOOL, CASE, CATCH, CONTINUE, DEFAULTCASE, DEFINE, FINALLY, FUNCALL, IF, LIST, LOCAL, MEMBER, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, QUASI, QUOTED, REF, RETURN, STRING, SWITCH, SYMBOL, TASK, TASKCALL, TEMPVAR, THROW, TR, TRY, UNIT, UNQUOTE, UNQUOTESPLICING, VAR, WHILE, errorlet, esnode, loglet,
    __slice = [].slice,
  ...
  AST.register(REF = (function(_super) {
    ...
    function REF(name, value, suffix) {
      this.name = name;
      this.value = value;
      this.suffix = suffix != null ? suffix : 0;
    }

    REF.prototype.normalized = function() {
      return this.name + (this.suffix > 0 ? "$" + this.suffix : '');
    };
    ...
    REF.prototype.local = function(init) {
      if (init == null) {
        init = true;
      }
      return AST.local(this, init);
    };

    REF.prototype.define = function() {
      return AST.define(this.name, this.value);
    };

    REF.prototype.toESNode = function() {
      return esnode.identifier(this.normalized());
    };
  ...
  AST.register(ASSIGN = (function(_super) {
    ...
    ASSIGN.prototype.toESNode = function() {
      return esnode.assign(esnode.identifier(this.name), this.value.toESNode());
    };
    ...
    ASSIGN.prototype.selfESNode = function() {
      return this.baseSelfESNode(esnode.literal(this.name), this.value.selfESNode());
    };
  ...
  AST.register(LOCAL = (function(_super) {
    ...
    function LOCAL(value, init) {
      this.value = value;
      this.init = init != null ? init : true;
      if (!(this.value instanceof REF)) {
        throw new Error("LOCAL:not_a_REF " + this.value);
      }
    }
    ...
    LOCAL.prototype.clone = function(val, init) {
      var ref;
      if (init == null) {
        init = true;
      }
      ref = AST.ref(this.value.name, val, this.value.suffix);
      return ref.local(init);
    };

    LOCAL.prototype.noInit = function() {
      return AST["var"](this.name());
    };
    ...
    LOCAL.prototype.normalized = function() {
    ...
    LOCAL.prototype.toString = function() {
      if (this.init) {
        return "{LOCAL " + (this.name()) + " = " + (this.normalized()) + "}";
      } else {
    ...
    LOCAL.prototype.toESNode = function() {
      if (this.init) {
        return esnode.declare('var', [esnode.identifier(this.name()), this.normalized().toESNode()]);
      } else {
    ...
    LOCAL.prototype.selfESNode = function() {
      return this.baseSelfESNode(this.value.selfESNode(), esnode.literal(this.init));
    };
  ...
  AST.register(PARAM = (function(_super) {
    ...
    PARAM.prototype.toESNode = function() {
      return esnode.identifier(this.name);
    };

    PARAM.prototype.selfESNode = function() {
      var defaultVal, type, _ref, _ref1;
      type = ((_ref = this.type) != null ? _ref.selfESNode() : void 0) || esnode.literal(this.type);
      defaultVal = ((_ref1 = this["default"]) != null ? _ref1.selfESNode() : void 0) || esnode.literal(this["default"]);
      return this.baseSelfESNode(esnode.literal(this.name), type, defaultVal);
    };
  ...
  AST.register(PROCEDURE = (function(_super) {
    ...
    PROCEDURE.prototype.toESNode = function() {
      var func, maker, param;
      func = esnode["function"](this.name, (function() {
        var _i, _len, _ref, _results;
        _ref = this.params;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
      ...
      return esnode.funcall(maker, [func, this.selfESNode()]);
    };
  ...
  AST.register(TASK = (function(_super) {
    ...
    TASK.prototype.toESNode = function() {
      var param;
      return esnode["function"](this.name, (function() {
        var _i, _len, _ref, _results;
        _ref = this.params;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
  ...
  AST.register(TRY = (function(_super) {
    ...
    TRY.prototype.toESNode = function() {
      var exp, _ref;
      return escode["try"](this.body.toESNode(), (function() {
        var _i, _len, _ref, _results;
        _ref = this.catches;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
