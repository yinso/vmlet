...
(function() {
  var ARRAY, ASSIGN, AST, BINARY, BINDING, BLOCK, BOOL, BREAK, CASE, CATCH, CONTINUE, DECLARE, DEFAULTCASE, DEFINE, EXPORT, FINALLY, FUNCALL, IF, IMPORT, LOCAL, MEMBER, MODULE, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, REF, RETURN, STRING, SWITCH, SYMBOL, TASK, TASKCALL, THROW, TOPLEVEL, TR, TRY, UNIT, WHILE, errorlet, loglet, moduleID, runtimeID, util, _hashCode,
    __slice = [].slice,
  ...
  AST.register(SYMBOL = (function(_super) {
    ...
    SYMBOL.prototype._pretty = function(level, dupe) {
      return "{S:" + this.value + ";" + this.count + "}";
    };
  ...
  AST.register(REF = (function(_super) {
    ...
    REF.prototype._pretty = function(level, dupe) {
      var _ref;
      return ['{ref ', this.isDefine ? '!' : ((_ref = this.value) != null ? _ref.type() : void 0) === 'proxyval' ? '%' : '', this.name._pretty(level, dupe), '}'];
    };
  ...
  */
  ...
  AST.register(DECLARE = (function(_super) {
    ...
    DECLARE.prototype._pretty = function(level, dupe) {
