...
(function() {
  ...
  AST.register(REF = (function(_super) {
    ...
    REF.prototype.clone = function() {
      return AST.ref(this.name.clone(), this.value);
    };
  ...
  AST.register(LET = (function(_super) {
    ...
    LET.prototype.toString = function() {
      return "{LET " + this.defines + " " + this.body + "}";
    };
  ...
  AST.register(IMPORT = (function(_super) {
    ...
    IMPORT.prototype.proxy = function(binding) {
      return AST.proxyval(binding.as, AST.funcall(AST.member(moduleID, AST.symbol('get')), [AST.string(binding.as.value)]));
    };
