...
(function() {
  var ARRAY, ASSIGN, AST, BINARY, BINDING, BLOCK, BOOL, CASE, CATCH, CONTINUE, DEFAULTCASE, DEFINE, EXPORT, FINALLY, FUNCALL, IF, IMPORT, LOCAL, MEMBER, MODULE, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, REF, RETURN, STRING, SWITCH, SYMBOL, TASK, TASKCALL, TEMPVAR, THROW, TOPLEVEL, TR, TRY, UNIT, VAR, WHILE, errorlet, loglet, _hashCode,
    __slice = [].slice,
