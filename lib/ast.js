...
(function() {
  var ARRAY, ASSIGN, AST, BINARY, BLOCK, BOOL, CATCH, DEFINE, FINALLY, FUNCALL, IF, LIST, LOCAL, MEMBER, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, QUASI, QUOTED, REF, RETURN, STRING, SYMBOL, TASK, TASKCALL, TEMPVAR, THROW, TRY, UNIT, UNQUOTE, UNQUOTESPLICING, WHILE, errorlet, esnode, loglet,
    __slice = [].slice,
  ...
  AST.register(ASSIGN = (function(_super) {
    ...
    ASSIGN.prototype.toESNode = function() {
      return esnode.assign(this.name, this.value);
    };
  ...
  AST.register(DEFINE = (function(_super) {
    ...
    DEFINE.prototype.toESNode = function() {
      return esnode.declare('var', [this.name, this.value.toESNode()]);
    };
  ...
  AST.register(LOCAL = (function(_super) {
    ...
    LOCAL.prototype.noInit = function() {
      return this.clone(this.normalized(), false);
    };
    ...
    LOCAL.prototype.toESNode = function() {
      if (this.init) {
        ...
        return esnode.declare('var', [this.name(), null]);
      }
    };
  ...
  AST.register(TEMPVAR = (function(_super) {
    ...
    TEMPVAR.prototype.toESNode = function() {
      return esnode.declare('var', [this.normalized(), this.value.toESNode()]);
    };
