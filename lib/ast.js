...
(function() {
  var ARRAY, AST, BINARY, BLOCK, BOOL, CATCH, DEFINE, FINALLY, FUNCALL, IF, LIST, MEMBER, NULL, NUMBER, OBJECT, PARAM, PROCEDURE, PROXYVAL, QUASI, QUOTED, REF, RETURN, STRING, SYMBOL, TASK, TASKCALL, TEMPVAR, THROW, TRY, UNIT, UNQUOTE, UNQUOTESPLICING, WHILE, errorlet, loglet,
    __slice = [].slice,
  ...
  AST.register(TEMPVAR = (function(_super) {
    ...
    TEMPVAR.prototype.toString = function() {
      return "{TEMPVAR " + this.name + " " + this.val + "}";
    };
  ...
  AST.register(PROXYVAL = (function(_super) {
    ...
    function PROXYVAL(name, val, _compile) {
      this.name = name;
      this.val = val;
    ...
    PROXYVAL.prototype.toString = function() {
      return "{PROXYVAL " + this.name + " " + this.val + "}";
    };
