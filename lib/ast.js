...
(function() {
  ...
  AST.register(TOPLEVEL = (function(_super) {
    ...
    function TOPLEVEL(body) {
      ...
      switch (this.body.type()) {
        case 'block':
          this.body = this.normalizeBlock(this.body);
          break;
        case 'define':
          this.body = this.normalizeDefine(this.body);
          break;
        default:
          this.body = this.normalizeOther(this.body);
      }
    }
    ...
    TOPLEVEL.prototype.toESNode = function() {
      return esnode.funcall(esnode.member(esnode.identifier('_rt'), esnode.identifier('toplevel')), [esnode["function"](null, [this.moduleParam.toESNode(), this.callbackParam.toESNode()], this.body.toESNode()), esnode.member(esnode.identifier('_rt'), esnode.identifier('main'))]);
    };
  ...
  AST.register(MODULE = (function(_super) {
    ...
    MODULE.prototype._equals = function(v) {
      return this.body.equals(v.body);
    };

    MODULE.prototype.isAsync = function() {
      return false;
    };
    ...
    MODULE.prototype.toESNode = function() {
      return esnode.funcall(esnode.member(esnode.identifier('_rt'), esnode.identifier('module')), [this.body.toESNode()]);
    };
