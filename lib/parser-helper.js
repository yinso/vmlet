...
(function() {
  ...
  define = function(id, val) {
    return AST.make('define', id.value, val);
  };
  ...
  funcDecl = function(name, params, body, returns) {
    ...
    return AST.make('procedure', (name ? name.value : name), params, body, returns);
  };
  ...
  taskDecl = function(name, params, body, returns) {
    ...
    return AST.make('task', (name ? name.value : name), params, body, returns);
  };
