...
(function() {
  var AST, ArgsArray, argsArray, array, block, bool, catchAST, define, finallyAST, funcDecl, ifAST, loglet, member, nullAST, number, object, operator, param, string, symbol, throwAST, tryAST;
  ...
  funcDecl = function(name, params, body, returns) {
    ...
    return AST.make('proc', (name ? name.val : name), params, body, returns);
  };
