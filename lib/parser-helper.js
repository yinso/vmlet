...
(function() {
  var AST, ArgsArray, argsArray, array, binding, block, bool, catchAST, define, export_, finallyAST, funcDecl, funcall, ifAST, import_, let_, loglet, member, nullAST, number, object, operator, param, string, symbol, taskDecl, taskcall, throwAST, tryAST;
