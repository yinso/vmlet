...
(function() {
  var AST, ArgsArray, argsArray, array, block, bool, catchAST, define, finallyAST, funcDecl, funcall, ifAST, import_, loglet, member, nullAST, number, object, operator, param, string, symbol, taskDecl, taskcall, throwAST, tryAST;
